...
var ajax_load="<br/><center><img src='/BMG2G_WEB/resources/images/ajax-loader.gif' border='0' /></center>";
...
$("#division"+globalDivisionId).animate(
 ...
 $("#division"+globalDivisionId).html($("#division"+globalDivisionId).html()+"&nbsp;&nbsp;&nbsp;<a href='ministryLotteryResultDownload.action?divisionId="+globalDivisionId+"'><img src='/BMG2G_WEB/resources/images/pdf.png' border='0' /></a>");
