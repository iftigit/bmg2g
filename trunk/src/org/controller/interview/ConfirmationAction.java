...
public class ConfirmationAction extends ActionSupport implements ServletContextAware{
	...
	public String execute()
	{
		...
		if(genearaInfo==null)
		{
			...
			"      <img src='/BMG2G_WEB/resources/images/sorryIcon.png' border='0' /> " +
			"    </td> " +
			"  </tr> " +
			"  <tr> " +
		...
		{
			String imageStr="<img src='/BMG2G_WEB/resources/images/smile.jpg' border='0' width='150' height='150' />";
			String messageStr="Congratulation";
			if(!genearaInfo.getTtcId().equalsIgnoreCase(loggedInUser.getDivisionId()))
			{
				imageStr="<img src='/BMG2G_WEB/resources/images/redAlert.png' border='0' width='150' height='150' />";
			...
			{
				imageStr="<img src='/BMG2G_WEB/resources/images/blueAlert.png' border='0' width='150' height='150' />";
