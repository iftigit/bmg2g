...
public class EditAction extends ActionSupport implements ServletContextAware{
	...
	public String updateJobseekerDetail()
	{
		...
		if(personalDTO.getContactName()==null || personalDTO.getContactName().equalsIgnoreCase(""))
		{
			messages+="* Please provide contact person name.";			
		}
		if(personalDTO.getContactMobile()==null || personalDTO.getContactMobile().equalsIgnoreCase(""))
		{
